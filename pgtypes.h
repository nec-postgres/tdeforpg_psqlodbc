...
/* extern TDEforPG data type */
extern OID PG_TYPE_ENCRYPT_TEXT;
extern OID PG_TYPE_ENCRYPT_BYTEA;
extern OID PG_TYPE_ENCRYPT_NUMERIC;
extern OID PG_TYPE_ENCRYPT_TIMESTAMP;
extern OID PG_TYPE_ENCRYPT_INTEGER;
