...
int main(int argc, char **argv)
{
	...
	CHECK_STMT_RESULT(rc, "SQLPrepare failed_1", hstmt);
	...
	CHECK_STMT_RESULT(rc, "SQLParamData failed_1", hstmt);
	...
	CHECK_STMT_RESULT(rc, "SQLPrepare failed_2", hstmt);
	...
	CHECK_STMT_RESULT(rc, "SQLParamData failed_2", hstmt);
